...
namespace BlackFox
{
    void BFLuaScriptingPhysicsEntity::registerEntity()
    {
        ...
        //Ray cast
        const auto rayCast = [&](BFWorld::Ptr world, const BFVector2f& startPoint, const BFVector2f& endPoint) -> auto
        {
            BFHitInfo hitInfo;
        ...
        const auto rayCastWithRay = [rayCast](BFWorld::Ptr world, const BFRay& ray) -> auto
        {
        ...
        //Ray cast all
        const auto rayCastAll = [](BFWorld::Ptr world, const BFVector2f& startPoint, const BFVector2f& endPoint)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
            if (!physicsSystem)
            {
        ...
        //Apply force
        const auto applyForceWithWake = [](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &force, const BFVector2f &point, bool wake = true)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
        ...
        const auto applyForce = [applyForceWithWake](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &force, const BFVector2f &point)
        {
        ...
        const auto applyForceToCenterWithWake = [](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &force, bool wake = true)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
            if (!physicsSystem) BF_WARNING("Failed to apply force: PhysicsSystem not found");
        ...
        const auto applyForceToCenter = [applyForceToCenterWithWake](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &force)
        {
        ...
        //Apply torque
        const auto applyTorqueWithWake = [](BFWorld::Ptr world, BFRigidBodyComponent& rb, float torque, bool wake = true)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
            if (!physicsSystem) BF_WARNING("Failed to apply force: PhysicsSystem not found");
        ...
        const auto applyTorque = [applyTorqueWithWake](BFWorld::Ptr world, BFRigidBodyComponent& rb, float torque)
        {
        ...
        const auto applyLinearImpulseWithWake = [](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &impulse, const BFVector2f &point, bool wake = true)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
            if (!physicsSystem) BF_WARNING("Failed to apply force: PhysicsSystem not found");
        ...
        const auto applyLinearImpulse = [applyLinearImpulseWithWake](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &impulse, const BFVector2f &point)
        {
        ...
        const auto applyLinearImpulseToCenterWithWake = [](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &impulse, bool wake = true)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
            if (!physicsSystem) BF_WARNING("Failed to apply force: PhysicsSystem not found");
        ...
        const auto applyLinearImpulseToCenter = [applyLinearImpulseToCenterWithWake](BFWorld::Ptr world, BFRigidBodyComponent &rb, const BFVector2f &impulse)
        {
        ...
        const auto applyAngularImpulseWithWake = [](BFWorld::Ptr world, BFRigidBodyComponent& rb, float impulse, bool wake = true)
        {
            auto physicsSystem = world->getSystem<Systems::BFPhysicsSystem>();
            if (!physicsSystem) BF_WARNING("Failed to apply force: PhysicsSystem not found");
        ...
        const auto applyAngularImpulse = [applyAngularImpulseWithWake](BFWorld::Ptr world, BFRigidBodyComponent& rb, float impulse)
        {
